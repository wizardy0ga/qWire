...
from core.Qt5.settings_gui.duck_dns_token_window import Ui_dns_token_window
from core.Qt5.settings_gui.domains_window import Ui_domains_window
from core.Qt5.settings_gui.webhook_window import Ui_webhook_dialog
from core.Qt5.icons import IconObj
from core.utils.utils import Validation,Notifications, ErrorHandling
from core.utils.file_paths import BGPath,CFGFilePath
from core.logging.logging import NetworkingConfigs,DNSconfigs,DiscordCFG
...
class Ui_settings_window(object):
    ...
    def setupUi(self, settings_window):
        ...
        self.enable_discord_combobox.setObjectName("enable_discord_combobox")
        ...
        """
        Add tabs to the settings tab box widget
        """
